...
footer.innerHTML = `
    ...
    <div class="border-t max-w-7xl p-5 w-full mx-auto mb-5">
        <div class="flex items-center justify-center px-5">
            <a href="/index.html" class="flex lg:gap-2 gap-1 md:h-24 h-20 items-center justify-center ">
                <img src="/Docs/Assets/logo.png" class="lg:h-16 h-14" alt="">
                <h1
                    class="font-bold lg:text-3xl text-lg lg:max-w-none max-w-[6rem] w-full leading-tight text-[#19384c]">
                    Smart Compare</h1>
            </a>
        </div>
